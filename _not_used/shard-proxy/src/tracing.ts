...
const expressInstrumentation = new ExpressInstrumentation({
  requestHook: (span: Span, req) => {
    ...
    span.setAttribute('service.name', 'shard-proxy');
  },
...
const sdk = new NodeSDK({
  resource: new Resource({
    [SemanticResourceAttributes.SERVICE_NAME]: 'shard-proxy',
...
async function initTracing() {
  console.debug('[shard-proxy] Initializing tracing...');
  await sdk.start();
  console.debug('[shard-proxy] Tracing initialized successfully');
}
